...
const About = () => {
  return (
    <section id="about" className="bg-[#252675] text-white pb-20">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center text-sm">
            ...
            >
              <button className="p-4 my-4 bg-blue-600 text-white rounded-lg max-w-[15rem] hover:scale-110 hover:ml-4 duration-500">
                Download my resume
              </button>
            </a>
        </div>
